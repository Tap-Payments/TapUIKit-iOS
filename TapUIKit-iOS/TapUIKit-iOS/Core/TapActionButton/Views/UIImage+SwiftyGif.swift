...
internal typealias GifLevelOfIntegrity = Float

extension GifLevelOfIntegrity {
    internal static let highestNoFrameSkipping: GifLevelOfIntegrity = 1
    internal static let `default`: GifLevelOfIntegrity = 0.8
    internal static let lowForManyGifs: GifLevelOfIntegrity = 0.5
    internal static let lowForTooManyGifs: GifLevelOfIntegrity = 0.2
    internal static let superLowForSlideShow: GifLevelOfIntegrity = 0.1
}
