...
public class TapConstantManager {
    ...
    internal static let TapActionSheetStatusNotification:String = "ActionButtonStatusChanged"
    internal static let TapActionSheetBlockNotification:String = "ActionButtonBlockChanged"
